...
enum Category {
	...
	CaravanPurchase('CARAVAN_PURCHASE','CARAVAN_PURCHASE'),
	...
	CarPurchase('CAR_PURCHASE','CAR_PURCHASE'),
	...
	FingalLand('FINGAL_LAND','FINGAL_LAND'),
	FingalRates('FINGAL_RATES','FINGAL_RATES'),
	FingalShed('FINGAL_SHED','FINGAL_SHED'),
	FingalStudio('FINGAL_STUDIO','FINGAL_STUDIO'),
	FingalHouseWares('FINGAL_HOUSEWARES','FINGAL_HOUSEWARES'),
	...
	KimberleyKamperPurchase('KK_PURCHASE','KK_PURCHASE'),
	...
	PhonePlanIntl('PHONE_PLAN_INTL','PHONE_PLAN_INTL'),
